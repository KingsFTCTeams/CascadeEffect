...
//
#define CurrMotorPwr(nDriveSide)     ( (nDriveSide == LEFT_SIDE) ? motor[LeftUpperDrive] : motor[RightUpperDrive] )

#define LeftRawDriveEncoderVal   nMotorEncoder[LeftUpperDrive]
#define RightRawDriveEncoderVal  nMotorEncoder[RightUpperDrive]
...
void ApplyMotorPower(tDriveSide nDriveSide, int nMotorPower)
{
	...
	{
	  motor[LeftUpperDrive] = nMotorPower;
	  motor[LeftLowerDrive] = nMotorPower;
	}
	else if ( nDriveSide == RIGHT_SIDE )
	{
	  motor[RightUpperDrive] = nMotorPower;
	  motor[RightLowerDrive] = nMotorPower;
	}
}
