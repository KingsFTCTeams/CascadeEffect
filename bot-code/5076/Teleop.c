...
#pragma config(Motor,  mtr_S3_C1_1,     RRD,           tmotorTetrix, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S3_C1_2,     motorE,        tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S3_C2_1,     RFD,           tmotorTetrix, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S3_C2_2,     SPIN,          tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S4_C1_1,     LFD,           tmotorTetrix, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S4_C1_2,     LRD,           tmotorTetrix, openLoop, reversed, encoder)
